import React from 'react'
 ...
 const Downheader=()=> {
    return(
    <>
    <div className="flex flex-wrap bg-gray-100 md:block hidden justify-around items-center text=[#f9f9f9]">
        <div className='flex flex-col flex-wrap md:max-w-7xl mx-auto w-screen py-[30px]'>
